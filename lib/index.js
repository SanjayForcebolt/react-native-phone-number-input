...
import Phone from "../../../assets/CreateAccount/Phone.svg";
      ...
      <CountryModalProvider>
        ...
        >
          ...
          >
            ...
            <LinearGradient
              colors={validation ? ["red", "red"] : ["#5311FE", "#9D16E5"]}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
              style={[
                // styles.linearGradient,
                {
                  ...
                  marginLeft: -15,
                  borderRadius: 5,
                  // {height : this.state.onHover? textInputStyle.height-4 : textInputStyle.height,width:this.state.onHover? textInputStyle.width-4 : textInputStyle.width}
            ...
            >
              <TextInput
                style={[
                  ...
                  {
                    height: this.state.onHover
                      ? textInputStyle.height - 4
                      : textInputStyle.height,
                    width: this.state.onHover
                      ? textInputStyle.width - 4
                      : textInputStyle.width,
                    marginTop: this.state.onHover ? 2 : 0,
                    borderWidth: this.state.onHover ? 0 : 2,
                    alignSelf: "center",
                  },
                ]}
                ...
                selectionColor="rgba(219, 116, 255, 1)"
